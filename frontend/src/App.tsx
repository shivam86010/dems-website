...
import { Shield, Zap, Fingerprint, Database, ShieldCheck, Building2, Users, Gavel, Microscope } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-navy-900 via-deep-blue-800 to-navy-900 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-6xl flex flex-col lg:flex-row gap-8 lg:gap-12 items-center justify-center z-10">
        ...
        <div className="flex-1 text-center lg:text-left space-y-6 lg:space-y-8 px-4 lg:px-0">
          <div className="inline-flex items-center gap-3 bg-bg-card/10 backdrop-blur-sm rounded-full px-4 py-2 border border-bg-card/20 animate-slide-in-left">
            <Shield className="w-5 h-5 text-deep-blue-300" />
            <span className="text-sm font-medium text-bg-card/90">DEMS+ v2.0</span>
          </div>
          ...
          {/* Stats */}
          <div className="flex gap-8 justify-center lg:justify-start pt-4 animate-fade-in" style={{ animationDelay: '700ms' }}>
            <div>
              <div className="text-2xl font-bold text-bg-card">99.9%</div>
              <div className="text-xs text-bg-card/50">Uptime SLA</div>
            </div>
            <div className="w-px h-8 bg-bg-card/10"></div>
            <div>
              <div className="text-2xl font-bold text-bg-card">24/7</div>
              <div className="text-xs text-bg-card/50">Real-time Sync</div>
            </div>
            <div className="w-px h-8 bg-bg-card/10"></div>
            <div>
              <div className="text-2xl font-bold text-bg-card">AES-256</div>
              <div className="text-xs text-bg-card/50">Encryption</div>
            </div>
          </div>
      ...
      {/* Footer */}
      <div className="absolute bottom-6 left-0 right-0 text-center text-bg-card/30 text-xs">
        © 2024 DEMS+ - Distributed Evidence & Case Management System. All rights reserved.
      </div>
    </div>
  );
}
