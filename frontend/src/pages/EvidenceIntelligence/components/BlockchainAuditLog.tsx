...
// import { Shield, Copy, CheckCheck, ChevronDown, ChevronUp, Lock, Eye, Upload, Edit, Send } from 'lucide-react';
// // Backend integration point: replace with blockchain API /api/evidence/:id/chain-of-custody
// const auditEntries = [
//   {
//     id: 'chain-001',
...
//             <span className="text-2xs font-semibold text-success">CHAIN INTACT</span>
//           </div>
...
//       {/* Column headers */}
//       <div className="grid grid-cols-12 gap-3 px-3 pb-2 border-b border-border mb-2">
...
//           return (
//             <div key={entry.id} className="rounded-lg border border-border/60 overflow-hidden">
//               <div
//                 className="grid grid-cols-12 gap-3 px-3 py-2.5 items-center cursor-pointer hover:bg-muted/20 transition-colors"
//                 onClick={() => setExpandedId(isExpanded ? null : entry.id)}
//               >
//                 {/* TX ID */}
//                 <div className="col-span-2">
//                   <span className="hash-text truncate block">{entry.txId.slice(0, 18)}…</span>
//                 </div>
//                 {/* Action */}
//                 <div className="col-span-1 flex items-center gap-1.5">
//                   <Icon size={12} className={entry.color} />
//                   <span className={`text-2xs font-semibold ${entry.color}`}>
//                     {actionLabels[entry.action] ?? entry.action}
//                   </span>
//                 </div>
//                 {/* Actor */}
//                 <div className="col-span-2">
//                   <span className="text-2xs text-foreground truncate block">{entry.actor.split(' · ')[0]}</span>
//                   {entry.actor.includes('·') && (
//                     <span className="hash-text truncate block">{entry.actor.split(' · ')[1]}</span>
//                   )}
//                 </div>
//                 {/* Timestamp */}
//                 <div className="col-span-2">
//                   <span className="font-mono text-2xs text-muted-foreground">{entry.timestamp}</span>
//                 </div>
//                 {/* Block */}
//                 <div className="col-span-1">
//                   <span className="font-mono text-2xs text-cyan-400">{entry.block}</span>
//                 </div>
//                 {/* Hash */}
//                 <div className="col-span-2 flex items-center gap-1.5">
//                   <span className="hash-text truncate">{entry.hash.slice(0, 14)}…</span>
//                   <button
...
//                   >
//                     {isCopied ? <CheckCheck size={11} className="text-success" /> : <Copy size={11} />}
//                   </button>
//                 </div>
//                 {/* Status */}
//                 <div className="col-span-1">
...
//                     </span>
//                   ) : (
//                     <span className="text-2xs font-bold text-red-400">INVALID</span>
//                   )}
//                 </div>
//                 {/* Expand */}
...
//               {/* Expanded detail */}
//               {isExpanded && (
//                 <div className="px-4 pb-4 pt-2 border-t border-border/50 bg-muted/10 animate-fade-in">
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
//                     <div>
//                       <p className="text-2xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Full TX ID</p>
//                       <p className="hash-text break-all">{entry.txId}</p>
//                     </div>
//                     <div>
//                       <p className="text-2xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Note</p>
//                       <p className="text-xs text-foreground/80">{entry.note}</p>
//                     </div>
//                     <div>
//                       <p className="text-2xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Current Hash (SHA-256)</p>
//                       <p className="hash-text break-all">{entry.hash}</p>
//                     </div>
//                     <div>
//                       <p className="text-2xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Previous Hash</p>
//                       <p className="hash-text break-all">{entry.prevHash}</p>
//                     </div>
//                   </div>
//                 </div>
//               )}
...
//         <div>
//           <p className="text-xs font-semibold text-success">Chain Integrity Verified</p>
...
// components/BlockchainAuditLog.tsx
import { useState } from 'react';
import { Shield, Copy, CheckCheck, ChevronDown, ChevronUp, Lock, Eye, Upload, Edit, Send, Link, Hash, Fingerprint, Award } from 'lucide-react';
